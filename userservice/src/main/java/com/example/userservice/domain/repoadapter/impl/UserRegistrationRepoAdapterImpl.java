...
import com.example.userservice.presistance.repo.UserRepository;
...
public class UserRegistrationRepoAdapterImpl
    ...
    protected UserRegistrationRepoAdapterImpl(UserMapper mapper, UserRepository repository, SequenceGeneratorImpl generatorService) {
        super(mapper, repository,generatorService);
